...
public interface CallFailureDAO extends JpaRepository<CallFailure, Long> {
	...
	List<Long> findDistinctImsiByDateTimeBetween(@Param("startDate") LocalDateTime startDate,
	...
	Long getModelFaliureCount(@Param("startDate") LocalDateTime startDate, @Param("endDate") LocalDateTime endDate,
			@Param("tac") Long tac);
}
